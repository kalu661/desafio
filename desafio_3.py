...
# Asignacion de años como entero
t = int(5);
...
# Division de la funcion con un punto flotante
result2 = float(y2/x2)
resultinf = 750

# Muestra en pantalla de años
print('Numero de animales cuando t -Tiempo- tiende a infinito: ',result2, '= 750');
print('-------------------------------------------------------------------')
